...
**(3) Genetic survey of hemoplasma infections**. The genetic survey was based on 16S rDNA sequences from hemoplasmas detected in the 22 infected mammalian species.

-> The genetic dataset (ie, fasta alignment of hemoplasma 16S rDNA sequences generated in this study and reference sequences retrieved from GenBank) is available [here](xxx).
